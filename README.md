...
| [hearth-in-plain-words.html](docs/hearth-in-plain-words.html) | **For anybody who is not a programmer.** How Hearth works in plain words, with diagrams, and how it differs from other ways of sharing a care record |
